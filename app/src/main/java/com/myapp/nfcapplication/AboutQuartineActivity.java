            ...
            switch (item.getItemId()) {
                ...
                case R.id.navigation_home:
                    if (getApplicationContext() instanceof UserActivity) {
                        ...
                        startActivity(new Intent(AboutQuartineActivity.this, UserActivity.class));
                        finish();
                    }
                    return true;
                ...
                case R.id.aboutcovid:
                    if (getApplicationContext() instanceof AboutCovidActivity) {
                        ...
                        startActivity(new Intent(AboutQuartineActivity.this, AboutCovidActivity.class));
                        finish();
                    }
                    return true;
...
/*                    if (getApplicationContext() instanceof AboutQuartineActivity) {
                        ...
                        startActivity(new Intent(AboutQuartineActivity.this, AboutQuartineActivity.class));
                        finish();
                    }
                    return true;*/
                    return true;
                ...
                case R.id.Location:
                    if( !prefs.getString(KeyValues.LATITUDE, "").equals("") && !prefs.getString(KeyValues.LONGITUDE, "").equals("")){
                        startActivity(new Intent(AboutQuartineActivity.this, UserMapActivity.class));
                        finish();
                    }else{

                        Toast.makeText(AboutQuartineActivity.this, "Home Location not yet set please set it.", Toast.LENGTH_SHORT).show();
                    }
                    return true;
